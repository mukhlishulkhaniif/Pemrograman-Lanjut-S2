...
namespace SearchingShorting
{
    public partial class Form1 : Form
    {
        ...
        void TampilkanDataGrid(int langkah)
        {
            ...
            // Update nilai sel aja tanpa hapus baris biar scroll aman
        ...
        void JalankanCountingSort()
        {
            ...
            // Isi output dari belakang (stable)
            for (int i = panjang - 1; i >= 0; i--)
            {
                int posisi = count[v[i] - min] - 1;

                outputNilai[posisi] = v[i];
                ...
                SimpanLangkah(
                    ...
                    new int[] { posisi },
                    new int[] { },
                    $"Tempatkan {n[i]} ({v[i]}) ke posisi {posisi}"
                );
            }
        ...
        // SEQUENTIAL SEARCH: Cari data dengan ngecek dari atas sampai bawah (Nilai Angka)
